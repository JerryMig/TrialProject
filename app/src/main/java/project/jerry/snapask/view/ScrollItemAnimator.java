...
/**
 * Created by Migme_Jerry on 2017/5/28.
 */

public class ScrollItemAnimator extends DefaultItemAnimator {

    private static final String TAG = "ScrollItemAnimator";
...
//    Map<RecyclerView.ViewHolder, AnimatorSet> heartAnimationsMap = new HashMap<>();
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        Log.d(TAG, "animateAdd position is " + viewHolder.getLayoutPosition());
...
//        }
    ...
    private void runEnterAnimation(final RecyclerView.ViewHolder holder) {
        final int screenHeight = AnimUtils.getScreenHeight(holder.itemView.getContext());
...
//    }
    ...
    public void endAnimation(RecyclerView.ViewHolder item) {
        Log.d(TAG, "endAnimations: endAnimations() with parameters is called ");
...
//        cancelCurrentAnimationIfExists(item);
    ...
    public void endAnimations() {
        Log.d(TAG, "endAnimations: endAnimations() without parameters is called ");
        super.endAnimations();
